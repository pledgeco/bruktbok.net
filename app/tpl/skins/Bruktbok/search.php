...
.clear{
	...
	<?php echo lang('search-books'); ?></h2>
	 <form id="searchForm" method="post" style="margin-top:1px; margin-bottom:10px;">
         <fieldset>

            <input id="s" type="text" placeholder="<?php echo lang('search-value'); ?>"/>
		...
		<h3 style="font-size:18px;">About 3 books found (0,33 seconds)</h3><br />
		<strong><a href="/book">E-commerce 2014 »</strong><br />
		<text style="color:#d6d6d6; font-size:14px;">By Ken Laudon - Seller: Tom</text></a><br /><br />
		<strong><a href="#">E-commerce 2014 »</strong><br />
		<text style="color:#d6d6d6; font-size:14px;">By Ken Laudon - Seller: Philip</text></a><br /><br />
		<strong><a href="#">E-commerce 2014 »</strong><br />
		<text style="color:#d6d6d6; font-size:14px;">By Ken Laudon - Seller: Jostein</text></a><br /><br />
